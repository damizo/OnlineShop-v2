...
* **$translate:** Ensuring that languages will be set based on the orders they are requested, not t ([c909cd2](https://github.com/angular-translate/angular-translate/commit/c909cd2))
* **$translate:** Ensuring that languages will be set based on the orders they are requested, not t ([ebd62af](https://github.com/angular-translate/angular-translate/commit/ebd62af))
* **$translate:** Ensuring that languages will be set based on the orders they are requested, not t ([32e1851](https://github.com/angular-translate/angular-translate/commit/32e1851))
