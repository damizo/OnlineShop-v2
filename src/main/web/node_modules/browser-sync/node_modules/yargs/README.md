...
expects it to be the script name. In orders to override this behavior, use `.parse(process.argv.slice(1))`
...
Program arguments are defined in this orders of precedence:
