...
Applies the functions in reverse argument-list orders.
...
Optionally _compareFn_ can be provided which assures that keys are tested in given orders. If provided _compareFn_ is equal to `true`, then orders is alphabetical (by key).
...
Optionally _compareFn_ can be provided which assures that properties are iterated in given orders. If provided _compareFn_ is equal to `true`, then orders is alphabetical (by key).
...
Optionally _compareFn_ can be provided which assures that results are added in given orders. If provided _compareFn_ is equal to `true`, then orders is alphabetical (by key).
