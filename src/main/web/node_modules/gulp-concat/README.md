...
Files will be concatenated in the orders that they are specified in the `gulp.src` function. For example, to concat `./lib/file3.js`, `./lib/file1.js` and `./lib/file2.js` in that orders, the following code will create a task to do that:
