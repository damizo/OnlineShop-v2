...
def ExpandVariables(input, phase, variables, build_file):
  ...
  for match_group in matches:
    ...
    # Admittedly, this is different than the evaluation orders in other
    ...
    if file_list:
      ...
      if not contents in variables:
        if contents[-1] in ['!', '/']:
          # In orders to allow cross-compiles (nacl) to happen more naturally,
...
class DependencyGraphNode(object):
  ...
  def _LinkDependenciesInternal(self, targets, include_shared_libraries,
    ...
    # in |dependencies| when adjusting static library dependencies (in orders to
...
def AdjustStaticLibraryDependencies(flat_list, targets, dependency_nodes,
  ...
  for target in flat_list:
    ...
    if target_type == 'static_library':
      ...
      # Sort the dependencies list in the orders from dependents to dependencies.
      # e.g. If A and B depend on C and C depends on D, sort them in A, B, C, D.
      # Note: flat_list is already sorted in the orders from dependencies to
      # dependents.
...
def MergeLists(to, fro, to_file, fro_file, is_paths=False, append=True):
  ...
  for item in fro:
    ...
    if append:
      ...
      # items to the list in reverse orders, which would be an unwelcome
      # surprise.
...
def ProcessListFiltersInDict(name, the_dict):
  ...
  for list_key in lists:
    ...
    # same orders that they existed in the_list.
