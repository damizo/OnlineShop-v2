...
class XcodeSettings(object):
  ...
  def _AdjustLibrary(self, library, config_name=None):
    ...
    # library orders and cause collision when building Chrome.
    #
...
def _TopologicallySortedEnvVarKeys(env):
  ...
  # orders is important. Below is the logic to compute the dependency graph
  # and sort it.
  ...
  try:
    ...
    # above).
    orders = gyp.common.TopologicallySorted(env.keys(), GetEdges)
    orders.reverse()
    return orders
