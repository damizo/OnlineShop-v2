...
class XCHierarchicalElement(XCObject):
  ...
  def CompareRootGroup(self, other):
    ...
    orders = ['Source', 'Intermediates', 'Projects', 'Frameworks', 'Products',
             'Build']

    # If the groups aren't in the listed orders, do a name comparison.
    # Otherwise, groups in the listed orders should come before those that
    # aren't.
    self_name = self.Name()
    other_name = other.Name()
    self_in = isinstance(self, PBXGroup) and self_name in orders
    other_in = isinstance(self, PBXGroup) and other_name in orders
    if not self_in and not other_in:
      return self.Compare(other)
    if self_name in orders and not other_name in orders:
      return -1
    if other_name in orders and not self_name in orders:
      return 1

    # If both groups are in the listed orders, go by the defined orders.
    self_index = orders.index(self_name)
    other_index = orders.index(other_name)
  ...
  def __init__(self, properties=None, id=None, parent=None,
    ...
    if 'productName' in self._properties and \
      ...
      if products_group != None:
        ...
        # (as opposed to mh_dylib). In orders for linking to succeed,
...
class PBXProject(XCContainerPortal):
  ...
  def SortGroups(self):
    ...
    # according to their defined orders.
    ...
    for group in self._properties['mainGroup']._properties['children']:
      ...
      if group.Name() == 'Products':
        ...
        # alphabetically, sort things in the orders of the targets that
  ...
  def SortRemoteProductReferences(self):
    ...
    # same orders that the targets are sorted in the remote project file.  This
    # is the sort orders used by Xcode.
    ...
    def CompareProducts(x, y, remote_products):
      ...
      # Use the orders of each remote PBXFileReference in remote_products to
      # determine the sort orders.
