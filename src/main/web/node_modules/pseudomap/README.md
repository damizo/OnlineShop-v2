...
Note that because object traversal orders of plain objects is not
guaranteed to be identical to insertion orders, the insertion orders
...
module works, `forEach` does traverse data in insertion orders.
