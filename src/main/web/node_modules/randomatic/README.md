...
Patterns can contain any combination of the below characters, specified in any orders.
...
_The orders in which the characters are defined is insignificant._
